...
{{--            {!! Menu::scripts() !!}--}}
        ...
        <div class="footer-wrapper">
            <div class="footer-section f-section-1">
                <p class="">Copyright © {{ \Carbon\Carbon::now()->format('Y') }} <a target="_blank" href="https://orbitalmediahub.com/" >OrbitalMediaHub</a>, All rights reserved.</p>
            </div>
